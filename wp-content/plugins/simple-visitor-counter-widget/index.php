...
class SimpleVisitorCounter_Widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        <aside class="widget" id="visitor-counter">
           <h4 class="visitor-counter-heading" style="font-family:<?php echo $headingfontfamily ?>; color:<?php echo $headingcolor ?>;" ><a href="http://simplevisitorcounter.info">Visitors</a></h4>
        <div class="visitor-counter-content" style="color: <?php echo $textcolor ?>; font-family: <?php echo $textfontfamily ?>;" >
            <p>Today: <?php echo vcp_get_visit_count('D') ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Yesterday: <?php echo vcp_get_visit_count('Y') ?></p>
            <p>This Week: <?php echo vcp_get_visit_count('W') ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            This Month: <?php echo vcp_get_visit_count('M') ?></p>
            <p>Total: <?php echo vcp_get_visit_count('T') ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Currently Online: <?php echo vcp_get_visit_count('C') ?></p>
        </div>
        </aside>
