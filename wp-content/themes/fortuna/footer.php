...
<?php } ?>  
  ...
  <script>
  	if ((Function('/*@cc_on return document.documentMode===11@*/')()) || (Function('/*@cc_on return document.documentMode===10@*/')()) || (Function('/*@cc_on return document.documentMode===9@*/')()) || (Function('/*@cc_on return document.documentMode===8@*/')()) || (Function('/*@cc_on return document.documentMode===7@*/')()) || (Function('/*@cc_on return document.documentMode===6@*/')()) || (Function('/*@cc_on return document.documentMode===5@*/')())){
    isIE = true;
    alert("Trình duyệt Internet Explore này đã lỗi thời. Xin vui lòng thay thế bằng trình duyệt Chrome hoặc Firefox!!!");
}else{
    isIE = false;
}
  </script>
